...
public class NextPartL2CreateService {
   ...
   static void createNextPart2rightReflection1stay(final FieldEngine fieldEngine) {
      ...
      setNextPart(fieldEngine, l2EnginePos, l1StayEnginePos, 2,
              ...
              stayMetaPosArgArr,
              new NextPart(l1EnginePos, calcL1S10S00NextPartMetaStatePosArr(fieldEngine, l1E), LR_CONTINUE_MATRIX /*metaPos(l1E, RIGHTa_p1_u0, NULL_u0_u0)*/, +0,
                      l0EnginePos, calcL0S1NextPartMetaStatePosArr(fieldEngine, l0E), LR_REFLECTION_MATRIX /*metaPos(l0E, LEFTa_p1)*/, +2));
      ...
      setNextPart(fieldEngine, l2EnginePos, l1StayEnginePos, 1,
              ...
              stayMetaPosArgArr,
              new NextPart(l1EnginePos, calcL1S10S00NextPartMetaStatePosArr(fieldEngine, l1E), LR_CONTINUE_MATRIX /*metaPos(l1E, RIGHTa_p1_u0, NULL_u0_u0)*/, -1,
                      l0EnginePos, calcL0S1NextPartMetaStatePosArr(fieldEngine, l0E), LR_REFLECTION_MATRIX /*metaPos(l0E, LEFTa_p1)*/, +1));
   ...
   static void createNextPart2leftReflection1stay(final FieldEngine fieldEngine) {
      ...
      setNextPart(fieldEngine, l2EnginePos, l1StayEnginePos, -3,
              ...
              stayMetaPosArgArr,
              new NextPart(l1EnginePos, calcL1S00S01NextPartMetaStatePosArr(fieldEngine, l1E), LR_CONTINUE_MATRIX /*metaPos(l1E, NULL_u0_u0, LEFTa_u0_p1)*/, +1,
                      l0EnginePos, calcL0S1NextPartMetaStatePosArr(fieldEngine, l0E), LR_REFLECTION_MATRIX /*metaPos(l0E, RIGHTa_p1)*/, -1));
      ...
      setNextPart(fieldEngine, l2EnginePos, l1StayEnginePos, -2,
              ...
              stayMetaPosArgArr,
              new NextPart(l1EnginePos, calcL1S00S01NextPartMetaStatePosArr(fieldEngine, l1E), LR_CONTINUE_MATRIX /*metaPos(l1E, NULL_u0_u0, LEFTa_u0_p1)*/, +2,
                      l0EnginePos, calcL0S1NextPartMetaStatePosArr(fieldEngine, l0E), LR_REFLECTION_MATRIX /*metaPos(l0E, RIGHTa_p1)*/, +0));
      //new NextPart(l1EnginePos, metaPos(l1E, NULL_u0_u0, LEFTa_u0_p1), +1,
