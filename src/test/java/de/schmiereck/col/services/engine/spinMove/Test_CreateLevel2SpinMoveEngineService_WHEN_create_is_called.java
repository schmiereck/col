...
public class Test_CreateLevel2SpinMoveEngineService_WHEN_create_is_called {
   ...
   void GIVEN_call_THEN_state_is_created() {
      ...
      final Engine engine = CreateLevel2SpinMoveEngineService.createLevel2SpinMoveEngine();
